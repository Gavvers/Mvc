...
namespace Microsoft.AspNetCore.Mvc.ModelBinding.Binders
{
    public class DictionaryModelBinderTest
    {
        ...
        public async Task BindModel_Succeeds(bool isReadOnly)
        {
            ...
            var binder = new DictionaryModelBinder<int, string>(new SimpleTypeModelBinder(typeof(int)), new SimpleTypeModelBinder(typeof(string)));
        ...
        {
            // Arrange
            var binder = new DictionaryModelBinder<string, string>(new SimpleTypeModelBinder(typeof(string)), new SimpleTypeModelBinder(typeof(string)));
        ...
        public async Task BindModel_FallsBackToBindingValues_WithValueTypes(IDictionary<long, int> dictionary)
        {
            ...
            var binder = new DictionaryModelBinder<long, int>(new SimpleTypeModelBinder(typeof(long)), new SimpleTypeModelBinder(typeof(int)));
        ...
        {
            // Arrange
            var binder = new DictionaryModelBinder<int, int>(new SimpleTypeModelBinder(typeof(int)), new SimpleTypeModelBinder(typeof(int)));
